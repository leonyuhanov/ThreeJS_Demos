...
{	
	...
	{
		return this._variableList[this.findVariableIndex(this.getAnimationName(this._currentAnimation),varName)][2];
	}
	...
	{
		this._variableList[this.findVariableIndex(this.getAnimationName(this._currentAnimation),varName)][2] = varValue;
	} 
	...
	getFunctions = function(animationIndex)
	{
		...
		{
			if(this._functions[this._currentFunctionIndex][0]==this.getAnimationName(animationIndex))
			{
