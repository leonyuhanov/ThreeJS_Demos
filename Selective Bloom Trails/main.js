...
import threeCubeoid from './BoilerPlate/threeCubeoid.js';				//threeCubeoid
...
{	
	...
	{
		objectTape.push( new threeCubeoid());
		objectTape[objectCounter].init(scene, 0);
		objectTape[objectCounter].radius = 50+(objectCounter*2)
		objectTape[objectCounter].pointsPerOutline = 100;
		objectTape[objectCounter].trailPoints = 20;
		objectTape[objectCounter].trailPointSpacing = 0.005
		objectTape[objectCounter].trailSpacingType = 1;
		objectTape[objectCounter].drawOutline = true;
		objectTape[objectCounter].outlineOpacity = 0.2;
		objectTape[objectCounter].rotationalVectors = [((Math.PI/180)*2)*Math.random(),((Math.PI/180)*2)*Math.random(),((Math.PI/180)*2)*Math.random()];
		objectTape[objectCounter].startAngle = 45;
		objectTape[objectCounter].pointsPerFace = 4;
		objectTape[objectCounter].equalTrailStart = 0;
		objectTape[objectCounter].enableVoidEnvelop = 0;
		objectTape[objectCounter].subRadius = 30;
...
function animate() 
{
	...
	{
		objectTape[localObjectCounter].animate(innerCIndex,1,0.001, [ 0,0,0 ], 0);
		/*
		if(scaleChange==1)
		{
			objectTape[localObjectCounter].updatePath( objectTape[localObjectCounter].radius );
		}
		*/
	}
