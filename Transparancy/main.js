...
function setUp()
{
	...
	{
		oIndex = oCount;
		centrePoints = getCircularPoints(0, 0, 20, ((360/numberOfObjects)*oCount)+frameCounter);
		...
		material[oIndex].opacity = 1-((oCount/numberOfObjects)*1);
		console.log(material[oIndex].opacity);
...
function animate() 
{
	...
	{
		oIndex = oCount;
		centrePoints = getCircularPoints(0, 0, (frameCounter)%30, ((360/numberOfObjects)*oCount)+frameCounter);
		cubes[oIndex].position.x = centrePoints[0];
		cubes[oIndex].position.y = centrePoints[1];
		cubes[oIndex].position.z = 0;
		cObjectOne.getColour(innerCIndex%cObjectOne._bandWidth);
